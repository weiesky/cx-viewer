...
export const ELECTRON_RUNTIME_REQUIRED_FILES = Object.freeze([
  ...
  join('lib', 'terminal-state-model.js'),
  join('lib', 'terminal-state-worker.js'),
  join('node_modules', '@xterm', 'headless', 'package.json'),
  join('node_modules', '@xterm', 'addon-serialize', 'package.json'),
