...
- Concepts and docs: English and Chinese docs have first-pass coverage; other locales still contain old cc-viewer / Claude Code / Anthropic API wording and need a separate translation pass.
...
- Web terminal startup through `cxv -d` has been verified in the browser. Keep this path under regression coverage as the remaining UI conversion work continues.
