  ...
  for (const [key, value] of Object.entries(safe)) {
    if (key === 'headers') parts['root.headers'] = value;
      ...
      if (value !== null && typeof value === 'object' && !Array.isArray(value)) {
        ...
        // Historical V1 records use response:null for in-progress and failed
        // captures. Preserve non-object containers verbatim instead of
        // silently dropping them during semantic splitting.
        root[key] = value;
      }
    } else {
      root[key] = value;
