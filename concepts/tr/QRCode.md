...
CC Viewer bir HTTP sunucusu başlatır ve bir **LAN adresi** oluşturur (ör: `http://192.168.1.100:7008`). QR kodu tarayarak aynı WiFi ağı üzerinden telefonunuzdan Codex'a erişebilirsiniz.
