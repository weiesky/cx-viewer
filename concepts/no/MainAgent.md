...
MainAgent er hovedforespørselskjeden i Codex når den ikke er i agent team-modus. Hver interaksjon mellom brukeren og Codex produserer en serie API-forespørsler, der MainAgent-forespørslene utgjør den sentrale samtalekjeden — de bærer komplett system prompt, verktøydefinisjoner og meldingshistorikk.
...
- System prompt inneholder "Codex"-kjennetekst

## Forskjell fra SubAgent

| Egenskap | MainAgent | SubAgent |
|----------|-----------|----------|
| system prompt | Komplett Codex hoved-prompt | Forenklet oppgavespesifikt prompt |
