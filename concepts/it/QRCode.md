...
CC Viewer avvia un server HTTP e genera un **indirizzo LAN** (es: `http://192.168.1.100:7008`). Scansiona il QR code per accedere a Codex dal tuo smartphone tramite la stessa rete WiFi.
